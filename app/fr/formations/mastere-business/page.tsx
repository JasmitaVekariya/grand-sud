        ...
        <section id="description" className="scroll-mt-32 space-y-16">
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-[16px] text-black leading-relaxed font-medium max-w-4xl">
              <p>Ce Mastère, destiné aux étudiants ayant des ambitions internationales, les forme aux enjeux du tourisme, de la culture française, et à la maîtrise du mix marketing et du management spécifiques au secteur.</p>
