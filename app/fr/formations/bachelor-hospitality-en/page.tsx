  ...
  const programYears = [
    {
      ...
      content: [
        ...
        {
          unit: "Unité de Compétences 4 – Expérience client",
          items: [
            { label: "Code du luxe", description: "Comprendre et maîtriser les codes du luxe" },
            { label: "Panorama de l'hospitalité", description: "Connaître les différentes structures, tendances et challenge en restauration et lieu d'accueil" },
            { label: "Management des équipes ménagères", description: "Maîtriser les fondamentaux de l'encadrement des équipes d'entretien" },
            { label: "Événementiel", description: "Savoir organiser un évènement" },
          ]
        }
      ]
    },
    {
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            { label: "Conception de produits touristiques", description: "Maîtriser les concepts de la phase d'analyse et de mise en œuvre jusqu'au marketing" },
            { label: "Tourisme éco-responsable", description: "Comprendre les enjeux environnementaux, sociaux et économiques liés au tourisme durable" },
            { label: "Développement durable dans l'hôtellerie et la restauration", description: "Explorer des stratégies pour minimiser le gaspillage alimentaire et promouvoir le recyclage" },
            { label: "Gestion de l'information touristique", description: "Maîtriser les principaux outils et logiciels de collecte, de traitement et de publication d'informations touristiques" },
          ]
        },
        {
          ...
          items: [
            ...
            { label: "Marketing en hôtellerie et restauration", description: "Comprendre les spécificités du mix marketing d'une structure d'hébergement ou de restauration (adaptation de l'offre aux différents clients, yield management, distribution, 3P de services)" },
            { label: "Management des opérations hôtelières", description: "Identifier les différents départements d'un hôtel, expliquer les interactions entre ces services, appliquer des méthodes de gestion pour optimiser la performance" },
    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          unit: "Unité de Compétences 3 – Expérience utilisateur",
          items: [
            { label: "Marketing des restaurants et de l'hébergement", description: "Comprendre les spécificités du mix marketing d'une structure d'hébergement ou de restauration (adaptation de l'offre aux différents clients, yield management, distribution, 3P de services)" },
            ...
            { label: "Gestion d'une structure d'hébergement", description: "Comprendre les spécificités RH, juridiques et financières d'une structure hôtelière (gérer le budget de fonctionnement et planifier les investissements, les KPI de l'hôtel/restaurant, la réglementation, la gestion des RH, du front et du back office)" },
          ]
        },
        {
          unit: "Unité de Compétences 4 – Management",
    ...
    categories: [
      {
        jobs: [
          ...
          { label: "Responsable d'hébergement (hôtel, résidence, auberge)", isDarkRed: false },
          { label: "Chargé de développement territorial touristique", isDarkRed: true },
          { label: "Responsable marketing hôtelier", isDarkRed: true },
          { label: "Manager en restauration", isDarkRed: false },
          { label: "Guest Experience Manager", isDarkRed: true },
          { label: "Yield Manager / Revenue Manager", isDarkRed: false },
          { label: "Assistant en gestion financière et administrative d'hôtel/restaurant", isDarkRed: false },
          { label: "Responsable relations clients internationaux", isDarkRed: true },
          { label: "Coordinateur interculturel / animation touristique", isDarkRed: false },
        ...
        <section id="description" className="scroll-mt-32 space-y-16">
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-[16px] text-black leading-relaxed font-medium max-w-4xl">
              <p>Ce Bachelor, formulé pour les étudiants visant l&apos;international, les forme aux enjeux du tourisme, à la culture française et aux domaines spécifiques de l&apos;accueil en hôtellerie et restauration.</p>
              ...
              <p>Il est fait pour les étudiants passionnés par les voyages, la culture et la relation client, diplômés d&apos;un bac (ou équivalent) à la recherche d&apos;une carrière dans le tourisme international ainsi que pour les étudiants européens et internationaux cherchant à étudier en France dans un environnement d&apos;apprentissage international.</p>
            </div>
          </div>
