...
export default function BtsMcoPage() {
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: "Tourism marketing", description: "Identify threats and opportunities, strengths and weaknesses in the environment and in a given tourism organisation, identify the characteristics of supply and demand (for a given service), choose appropriate distribution networks, select appropriate communication media" },
          ]
        },
        {
    ...
    processSteps: [
      {
        ...
        items: [
          { text: "Download the application for by clicking here (French only).", isLink: true, linkText: "clicking here (French only)." },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Response within 48 working hours: favourable or unfavourable decision", isItalic: true }
        ]
      },
      {
  ...
  const educationData = {
    ...
    links: [
      ...
      { label: "Bachelor Hospitality Management", href: "/en/courses/bachelor-hospitality", flag: "FR" as const },
      { label: "Bachelor Hospitality Management", href: "/en/courses/bachelor-hospitality", flag: "UK" as const },
      { label: "Bachelor Business & Tourism", href: "/en/courses/bachelor-business", flag: "UK" as const },
      { label: "In general, Level 6 titles", href: "#" }
    ],
    jobs: [
        ...
        <section id="objectives" className="scroll-mt-32 space-y-16">
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-[16px] text-black leading-relaxed font-medium max-w-4xl">
              ...
              <p>The BTS MCO aims to develop performance and skills in marketing and operational management of commercial units and teams. You may have missions such as: managing a commercial unit, choosing purchasing and sales policies, carrying out commercial promotion, managing customer relations, identifying a company's commercial needs, managing and animating the offer of products and services.</p>
            </div>
          </div>
          ...
          <div className="space-y-12">
            <div className="space-y-6 max-w-3xl">
              ...
              <p className="text-[16px] text-gray-700 leading-relaxed font-medium">
                With over 20 years of experience in preparing students for the BTS Tourism exams, the Grand Sud school knows the keys to success for obtaining this Level 5 qualification.
              </p>
            </div>
            ...
            <div className="w-full max-w-[835px]">
              ...
              <div className="bg-primary-red text-white p-8 flex items-center gap-8 h-[100px]">
                ...
                <p className="text-[18px] md:text-[20px] font-bold uppercase tracking-wide leading-tight">
                  100% of success in 2025, for the second consecutive year
                </p>
              </div>
              ...
              <div className="w-full flex flex-col">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 items-stretch w-full">
                  <div className="h-[140px] p-4 flex flex-col items-center justify-center text-center gap-4 bg-[#3F3F3F] transition-transform duration-300 hover:scale-[1.02] border-r border-b border-white/10">
                    ...
                    <p className="text-white text-[13px] font-bold tracking-wider leading-snug">Curiosity</p>
                  </div>
                  <div className="h-[140px] p-4 flex flex-col items-center justify-center text-center gap-4 bg-[#A93226] transition-transform duration-300 hover:scale-[1.02] border-r border-b border-white/10">
                    ...
                    <p className="text-white text-[13px] font-bold tracking-wider leading-snug">Dynamism</p>
                  </div>
                  <div className="h-[140px] p-4 flex flex-col items-center justify-center text-center gap-4 bg-[#3F3F3F] transition-transform duration-300 hover:scale-[1.02] border-r border-b border-white/10">
                    <PenTool size={32} strokeWidth={1.5} className="text-white/60" />
                    <p className="text-white text-[13px] font-bold tracking-wider leading-snug">Love for customer contact</p>
                  </div>
                  <div className="h-[140px] p-4 flex flex-col items-center justify-center text-center gap-4 bg-[#A93226] transition-transform duration-300 hover:scale-[1.02] border-b border-white/10">
                    <PenTool size={32} strokeWidth={1.5} className="text-white/60" />
                    <p className="text-white text-[13px] font-bold tracking-wider leading-snug">Analytical mind</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 items-stretch w-full">
                  <div className="h-[140px] p-4 flex flex-col items-center justify-center text-center gap-4 bg-[#A93226] transition-transform duration-300 hover:scale-[1.02] border-r border-white/10">
                    ...
                    <p className="text-white text-[13px] font-bold tracking-wider leading-snug">Team spirit</p>
                  </div>
                  <div className="h-[140px] p-4 flex flex-col items-center justify-center text-center gap-4 bg-[#3F3F3F] transition-transform duration-300 hover:scale-[1.02] border-r border-white/10">
                    ...
                    <p className="text-white text-[13px] font-bold tracking-wider leading-snug">Taste for challenge and management</p>
                  </div>
                  <div className="h-[140px] p-4 flex flex-col items-center justify-center text-center gap-4 bg-[#A93226] transition-transform duration-300 hover:scale-[1.02]">
                    ...
                    <p className="text-white text-[13px] font-bold tracking-wider leading-snug">Sense of responsibility</p>
                  </div>
                </div>
              </div>
            </div>
