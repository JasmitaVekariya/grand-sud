        ...
        <section id="description" className="scroll-mt-32 space-y-16">
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-[16px] text-black leading-relaxed font-medium max-w-4xl">
              <p>This Mastère's degree, designed for students with international ambitions, trains them in tourism issues, French culture, and mastery of the marketing mix and management specific to the sector.</p>
