      ...
      <div className="max-w-[1440px] mx-auto flex items-center justify-between md:px-[200px]">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link href="https://www.instagram.com/ecolegrandsud/" target="_blank" className="w-8 h-8 flex items-center justify-center bg-white/20 rounded-md hover:bg-white/40 transition-colors">
              <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
            ...
            <Link href="https://www.youtube.com/@ecolegrandsud" target="_blank" className="w-8 h-8 flex items-center justify-center bg-white/20 rounded-md hover:bg-white/40 transition-colors">
              <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
                <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
              </svg>
            </Link>
            <Link href="https://www.linkedin.com/school/ecolegrandsud/" target="_blank" className="w-8 h-8 flex items-center justify-center bg-white/20 rounded-md hover:bg-white/40 transition-colors">
              <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24">
