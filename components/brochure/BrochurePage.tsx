...
export default function BrochurePage() {
  ...
  const t = {
    en: {
      ...
      topText: "To download the brochure of the school, simply fill out the form below: you will receive it by email in a few minutes!",
      fields: {
        ...
        consent: "I agree to be contacted in regard to my search for information about our courses",
      },
