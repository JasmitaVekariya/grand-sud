...
export default function CallbackPage() {
  ...
  const t = {
    en: {
      heading: "ASK TO BE CALLED BACK",
      topText: "Would you like to speak with one of our advisors? Fill out this form and we will call you back within 24 to 48 hours to answer all your questions!",
      fields: {
        ...
        timeSlot: "Preferred time slot to be called",
        consent: "I agree to be called back in regard to my search for information about our courses",
      },
    ...
    fr: {
      heading: "DEMANDER À ÊTRE RAPPELÉ",
      topText: "Vous souhaitez échanger avec l'un de nos conseillers ? Remplissez ce formulaire et nous vous rappellerons sous 24 à 48 heures pour répondre à toutes vos questions !",
      fields: {
        firstName: "Prénom",
        surname: "Nom",
        email: "Email",
        ...
        consent: "J'accepte d'être rappelé au sujet de ma recherche d'informations sur nos formations",
      },
  ...
  // Set default values when language changes
  useEffect(() => {
    setFormData(prev => ({
      ...prev,
      timeSlot: lang === "fr" ? "Matin (9h - 12h)" : "Morning (9am - 12pm)"
    }));
  }, [lang]);
        ...
        <div className="relative h-full w-full overflow-hidden">
          ...
          >
            <div className="relative w-full h-full">
              {/* Using native HTML img or next/image, but let's use next/image by importing standard Image from 'next/image' (wait, there was a typo in imports: 'image' instead of 'next/image', let me use 'next/image') */}
              <img
                src="/assets/pexels-rdne-6170640-scaled.jpg"
                alt="Callback Background"
